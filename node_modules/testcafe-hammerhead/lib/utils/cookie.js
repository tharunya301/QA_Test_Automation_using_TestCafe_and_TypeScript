...
function formatSyncCookieKey(cookie) {
    ...
    const maxAge = !(0, lodash_1.isNil)(cookie.maxAge) && !isNaN(Number(cookie.maxAge)) && String(cookie.maxAge) !== 'Infinity' ? cookie.maxAge.toString(TIME_RADIX) : '';
...
function parseClientSyncCookieStr(cookieStr) {
    ...
    for (const cookie of cookies) {
        const parsedCookie = parseSyncCookie((0, string_trim_1.default)(cookie));
        if (parsedCookie)
